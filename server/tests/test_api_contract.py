...
def test_production_route_rejects_missing_token(production_client: TestClient) -> None:
    response = production_client.get("/api/v1/downloads/00000000-0000-0000-0000-000000000000")
...
def test_completed_file_downloads_without_auth_and_uses_display_name(
    ...
    try:
        ...
        nested = production_client.get(f"/api/v1/downloads/{job.id}/file/whatever-name.mp4")
